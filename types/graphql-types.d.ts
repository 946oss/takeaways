...
export type ContentfulPlace = Node & {
  ...
  childContentfulPlaceDescriptionTextNode?: Maybe<ContentfulPlaceDescriptionTextNode>,
  childContentfulPlaceMessageRichTextNode?: Maybe<ContentfulPlaceMessageRichTextNode>,
};
...
export type ContentfulPlaceFilterInput = {
  ...
  childContentfulPlaceDescriptionTextNode?: Maybe<ContentfulPlaceDescriptionTextNodeFilterInput>,
  childContentfulPlaceMessageRichTextNode?: Maybe<ContentfulPlaceMessageRichTextNodeFilterInput>,
};
...
export type ContentfulPlaceMessageRichTextNodeContent = {
  content?: Maybe<Array<Maybe<ContentfulPlaceMessageRichTextNodeContentContent>>>,
  nodeType?: Maybe<Scalars['String']>,
};
...
export type ContentfulPlaceMessageRichTextNodeContentContentFilterListInput = {
  elemMatch?: Maybe<ContentfulPlaceMessageRichTextNodeContentContentFilterInput>,
};

export type ContentfulPlaceMessageRichTextNodeContentFilterInput = {
  content?: Maybe<ContentfulPlaceMessageRichTextNodeContentContentFilterListInput>,
  nodeType?: Maybe<StringQueryOperatorInput>,
};
...
export type Query = {
  ...
  contentfulPlaceMessageRichTextNode?: Maybe<ContentfulPlaceMessageRichTextNode>,
  allContentfulPlaceMessageRichTextNode: ContentfulPlaceMessageRichTextNodeConnection,
  contentfulPlaceDescriptionTextNode?: Maybe<ContentfulPlaceDescriptionTextNode>,
...
export type Unnamed_1_Query = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'name' | 'keywords'>> }> };

export type IndexQueryQueryVariables = {};


export type IndexQueryQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allContentfulPlace: (
    Pick<ContentfulPlaceConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<ContentfulPlace, 'id' | 'official' | 'address' | 'closed_on' | 'business_hours' | 'facebook' | 'name' | 'tel'>
        & { description: Maybe<Pick<ContentfulPlaceDescriptionTextNode, 'description'>>, location: Maybe<Pick<ContentfulPlaceLocation, 'lat' | 'lon'>>, pictures: Maybe<Array<Maybe<(
          Pick<ContentfulAsset, 'id' | 'title'>
          & { file: Maybe<Pick<ContentfulAssetFile, 'url'>>, fixed: Maybe<Pick<ContentfulFixed, 'srcSet'>> }
        )>>>, message: Maybe<Pick<ContentfulPlaceMessageRichTextNode, 'json'>>, tags: Maybe<Array<Maybe<Pick<ContentfulPlaceTag, 'slug' | 'name'>>>> }
      ) }> }
  ), allContentfulPlaceTag: { edges: Array<{ node: (
        Pick<ContentfulPlaceTag, 'slug' | 'name'>
...
export type MapQueryQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allContentfulPlace: { edges: Array<{ node: (
        Pick<ContentfulPlace, 'id' | 'official' | 'business_hours' | 'name'>
        & { description: Maybe<Pick<ContentfulPlaceDescriptionTextNode, 'description'>>, location: Maybe<Pick<ContentfulPlaceLocation, 'lat' | 'lon'>> }
      ) }> } };
...
export type Unnamed_2_Query = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, contentfulPlace: Maybe<(
    Pick<ContentfulPlace, 'id' | 'official' | 'address' | 'closed_on' | 'business_hours' | 'facebook' | 'name' | 'tel'>
    & { description: Maybe<Pick<ContentfulPlaceDescriptionTextNode, 'description'>>, location: Maybe<Pick<ContentfulPlaceLocation, 'lat' | 'lon'>>, pictures: Maybe<Array<Maybe<(
      ...
      Pick<ContentfulAsset, 'id' | 'title'>
      & { file: Maybe<Pick<ContentfulAssetFile, 'fileName' | 'url' | 'contentType'>>, fixed: Maybe<Pick<ContentfulFixed, 'srcSet' | 'src'>> }
    )>>>, message: Maybe<Pick<ContentfulPlaceMessageRichTextNode, 'json'>>, tags: Maybe<Array<Maybe<Pick<ContentfulPlaceTag, 'slug' | 'name'>>>> }
  )> };
...
export type Unnamed_3_Query = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, contentfulPlaceTag: Maybe<Pick<ContentfulPlaceTag, 'name' | 'slug'>>, allContentfulPlace: (
    Pick<ContentfulPlaceConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<ContentfulPlace, 'id' | 'official' | 'address' | 'closed_on' | 'business_hours' | 'facebook' | 'name' | 'tel'>
        & { description: Maybe<Pick<ContentfulPlaceDescriptionTextNode, 'description'>>, location: Maybe<Pick<ContentfulPlaceLocation, 'lat' | 'lon'>>, pictures: Maybe<Array<Maybe<(
